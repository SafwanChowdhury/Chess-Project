...
/*------- DOM References -------*/
const cells = document.querySelectorAll("td"); //boardPieces
let whitePieces = document.querySelectorAll("p"); //whitePieces array of objects / objectId's
let blacksPieces = document.querySelectorAll("span"); //blackPieces array of objects / objectId's
const whiteTurntext = document.querySelectorAll(".white-turn-text");
const blackTurntext = document.querySelectorAll(".black-turn-text");
const divider = document.querySelector("#divider");

/*--- Player Properties ---*/
let turn = true; //need to export
let whiteScore = 16;
let blackScore = 16;
let playerPieces;
